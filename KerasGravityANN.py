...
class KerasGravityANN:
    ...
    def createNetwork(self,numHiddens):
        ...
        #dtype=float64
        model.add(Dense(numHiddens[0], input_dim=5, kernel_initializer='he_uniform', use_bias=True))
    ...
    def trainModel(self,inputs,targets,batchSize,numEpochs):
        ...
        history = self.model.fit(inputs, targets, epochs=numEpochs, shuffle=True, batch_size=batchSize, verbose=1, validation_split=0.2, callbacks=[csv_logger])
